...
wget -q -O /usr/bin/m-system https://raw.githubusercontent.com/hokagelegend2023/zeroversion/main/helium/menu/m-system.sh
...
wget -q -O /usr/bin/helium https://raw.githubusercontent.com/hokagelegend2023/zeroversion/main/helium/ins-helium.sh
